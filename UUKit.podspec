#
#  Be sure to run `pod spec lint UUKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "UUKit"
  # spec.authors            = { "UUKit" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/UUKit"
